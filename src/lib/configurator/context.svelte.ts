...
export class ConfiguratorSwitchProfileState {
  keys = new SvelteSet<number>()
...
export const switchProfileStateContext =
  new Context<ConfiguratorSwitchProfileState>("hmk-switch-profile-state")
...
export class ConfiguratorGlobalState {
  ...
  #switchProfileState: ConfiguratorSwitchProfileState
  ...
  constructor() {
    ...
    this.#switchProfileState = switchProfileStateContext.get()
  }
...
export function setConfiguratorStateContext() {
  ...
  switchProfileStateContext.set(new ConfiguratorSwitchProfileState())
  distanceDisplayContext.set(new DistanceDisplay())
