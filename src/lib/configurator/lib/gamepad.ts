...
export const analogCurvePresets: GamepadAnalogCurvePreset[] = [
  ...
  {
    name: () => m.analog_curve_aggressive(),
    curve: [
      { x: 4, y: 20 },
      { x: 55, y: 150 },
      { x: 145, y: 220 },
