...
<script lang="ts">
  ...
  import SwitchProfileKeyboard from "./switch-profile-keyboard.svelte"
  import SwitchProfileMenu from "./switch-profile-menu.svelte"
  import SwitchProfileMenubar from "./switch-profile-menubar.svelte"
...
<KeyboardEditor.Root {...props}>
  <KeyboardEditor.Pane>
    <SwitchProfileKeyboard />
    <SwitchProfileMenubar />
  </KeyboardEditor.Pane>
