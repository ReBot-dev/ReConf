...
<ConfiguratorLayout>
  ...
  {/await}
  {#await actuationPointTab then { default: ActuationPointTab }}
    <Tabs.Content value="actuation-point">
      {#snippet child({ props })}
        <ActuationPointTab {...props} />
      {/snippet}
    </Tabs.Content>
  {/await}
  {#await rapidTriggerTab then { default: RapidTriggerTab }}
    <Tabs.Content value="rapid-trigger">
      {#snippet child({ props })}
        <RapidTriggerTab {...props} />
      {/snippet}
    </Tabs.Content>
  {/await}
  ...
  {/await}
  {#await switchProfileTab then { default: SwitchProfileTab }}
    <Tabs.Content value="switch-profile">
      {#snippet child({ props })}
        <SwitchProfileTab {...props} />
      {/snippet}
    </Tabs.Content>
  {/await}
